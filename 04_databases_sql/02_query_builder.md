...
```php
$query->table('foobars')
->insert(['field1' => 'foo', 'field2' => new TimeImmutable]);
```
...
$query->table('foobars')
->insertMultiple(
	['field1' => 'foo1', 'field2' => new TimeImmutable],
	['field1' => 'foo2', 'field2' => new TimeImmutable]
);
```
...
```php
$query->table('foobars')
->insertAndGetId(['field1' => 'foo', 'field2' => new TimeImmutable]);
```
...
$query->table('foobars')
->insertOrUpdate(
	['field1' => 'foo', 'field2' => new TimeImmutable], 
	['field2' => new TimeImmutable]
);
```
...
$query->table('foobars')
->where('id', '=', 10)
->update(['field1' => 'foo', 'field2' => new TimeImmutable]);
```
